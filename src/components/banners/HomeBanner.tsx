    ...
    return (
        <div className="banner_outer">
            ...
            <figure className="banner-layerright mb-0">
                <img src="/src/assets/images/banner-layerright.png" className="img-fluid" alt=""/>
            </figure>
                        ...
                        <div className="col-lg-5 col-md-12 col-sm-12 col-12" data-aos="fade-right">
                            ...
                            <div className="banner_content">
                                <figure className="banner-line mb-0">
                                    <img src="/src/assets/images/banner-line.png" alt="" className="img-fluid"/>
                                </figure>
                                ...
                                <a className="get_started button2 text-white text-decoration-none" href="/contact">Contact
                                    ...
                                    <figure className="mb-0">
                                        <img src="/src/assets/images/button-arrow.png" alt="" className="img-fluid"/>
                                    </figure>
                                </a>
                                <figure className="banner-circleleft mb-0">
                                    <img src="/src/assets/images/banner-circleleft.png" className="img-fluid" alt=""/>
                                </figure>
                                <figure className="banner-dotleft mb-0">
                                    <img src="/src/assets/images/banner-dotleft.png" className="img-fluid" alt=""/>
                                </figure>
                            </div>
                        </div>
                        <div className="col-lg-7 col-md-12 col-sm-12 col-12">
                            <div className="banner_wrapper">
                                <figure className="mb-0 banner-image">
                                    <img src="/src/assets/images/banner-image.jpg" alt="" className="img-fluid"/>
                                </figure>
                                <figure className="banner-circleright mb-0">
                                    <img src="/src/assets/images/banner-circleright.png" className="img-fluid" alt=""/>
                                </figure>
                                <figure className="banner-dotright mb-0">
                                    <img src="/src/assets/images/banner-dotright.png" className="img-fluid" alt=""/>
                                </figure>
                            </div>
                        </div>
                    </div>
