                    ...
                    <div className="row position-relative">
                            ...
                            <div className="offer_boxcontent">
                                <div className="upper_portion">
                                    <figure className="mb-0">
                                        <img src="/src/assets/images/offer-image1.jpg" className="article_img" alt=""/>
                                    </figure>
                                    <div className="image_content">
                                        <figure className="offer-icon">
                                            <img src="/src/assets/images/offer-icon1.png" alt="" className="img-fluid"/>
                                        </figure>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-4 col-sm-6 col-xs-12 article_padding">
                            <div className="offer_boxcontent">
                                <div className="upper_portion">
                                    <figure className="mb-0">
                                        <img src="/src/assets/images/offer-image2.jpg" className="article_img" alt=""/>
                                    </figure>
                                    <div className="image_content">
                                        <figure className="offer-icon offer-icon2">
                                            <img src="/src/assets/images/offer-icon2.png" alt="" className="img-fluid"/>
                                        </figure>
                                    </div>
                                </div>
                                <div className="lower_portion_wrapper">
                        ...
                        <div className="col-lg-4 col-md-4 col-sm-6 col-xs-12 article_padding">
                            <div className="offer_boxcontent mb-0">
                                <div className="upper_portion">
                                    <figure className="mb-0">
                                        <img src="/src/assets/images/offer-image3.jpg" className="article_img" alt=""/>
                                    </figure>
                                    <div className="image_content">
                                        <figure className="offer-icon">
                                            <img src="/src/assets/images/offer-icon3.png" alt="" className="img-fluid"/>
                                        </figure>
                                    </div>
                                </div>
                                <div className="lower_portion_wrapper">
