                                ...
                                <div className="contact-box">
                                    <div className="box-image">
                                        <figure className="contact-location">
                                            <img src="/src/assets/images/contact-location.png" alt="" className="img-fluid"/>
                                        </figure>
                                    </div>
                                ...
                                <div className="contact-box">
                                    <div className="box-image">
                                        <figure className="contact-email">
                                            <img src="/src/assets/images/contact-email.png" alt="" className="img-fluid"/>
                                        </figure>
                                    </div>
                                    <div className="box-content">
                            ...
                            <div className="need-section">
                                ...
                                <div className="need_content">
                                    ...
                                    <figure className="faq-image mb-0">
                                        <img src="/src/assets/images/faq-image.png" alt="" className="img-fluid"/>
                                    </figure>
                                </div>
                            </div>
                        </div>
